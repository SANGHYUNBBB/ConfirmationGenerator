...
def create_termination_word_from_excel(
    ...
    try:
        ...
        # 8. 파일명: N20 값 사용, yymmdd는 오늘 날짜로 교체
        filename_value = sheet.Range("N20").Value
...
def generate_termination_confirmation(
    ...
    customer_password, base_filename, customer_email = create_termination_word_from_excel(
